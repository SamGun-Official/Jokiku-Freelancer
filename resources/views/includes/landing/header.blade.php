<section class="w-full border-box transition-all duration-500 linear lg:px-16 md:px-20 px-8 py-8 bg-white">
                    ...
                    @auth
                        ...
                        @if (Auth::user()->role == 'admin')
                            <a href="{{ route('admin.dashboard.index') }}"
                                class="block lg:hidden nav-link text-serv-text">Admin</a>
                        @else
                            <a href="{{ route('member.dashboard.index') }}"
                                class="block lg:hidden nav-link text-serv-text">User</a>
                        @endif
