                            ...
                            <table class="w-full" aria-label="Table">
                                <thead>
                                    <tr class="text-sm font-normal text-left text-gray-900 border-b border-b-gray-600">
                                        ...
                                        <th class="px-0 py-4" scope="">Service Name</th>
                                        <th class="px-0 py-4" scope="">Service Price</th>
                                        <th class="px-0 py-4" scope="">Service Status</th>
                                ...
                                <tbody class="bg-white">
                                    ...
                                    @forelse ($services as $key => $service)
                                        <tr class="text-gray-700 @if ($counter < count($services) - 1) border-b @endif">
                                            ...
                                            <td class="w-1/3 pr-7 py-5">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if (count($service->thumbnail_service) > 0)
                                                    ...
                                                    <div>
                                                        <p class="font-medium text-black flex-vcenter">
                                                            <span class="text-nowrap" style="max-width: 20rem;">
                                                                <a href="{{ route('detail.landing', ['id' => $service->id]) }}"
                                                                ...
                                                                @foreach ($reviews as $review)
                                                                    @if ($review->order->service->id == $service->id)
                                                                        <?php
                                            ...
                                            <td class="w-1/5 pr-7 py-5 text-sm text-black">
