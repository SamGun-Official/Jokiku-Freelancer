                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                            ...
                                            <option value="4" {{ $service->revision_limit == '5' ? 'selected' : '' }}>5 Revisi</option>
                                            <option value="8" {{ $service->revision_limit == '7' ? 'selected' : '' }}>7 Revisi</option>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse ($tagline as $tagline_item)
                                            <input placeholder="Tagline" type="text" name="{{ ('taglines['.$tagline_item->id.']') }}" id="taglines" autocomplete="ataglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->tagline ?? '' }}" required>
                                        @empty
                                            {{-- empty --}}
                                        @endforelse
