                ...
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    ...
                    <div class="p-6 mt-8 bg-white rounded-xl">
                        <div>
                            ...
                            <p class="text-sm text-gray-400">
                                {{ $progress ?? '' }} Total Orders In Progress
                            </p>
                        </div>
                        @if (count($orders) == 0)
                            <div class="mt-4">No order is in progress right now.</div>
                        @else
                                ...
                                <tbody class="bg-white">
                                    @forelse ($orders as $key => $item)
                                        <tr class="text-gray-700">
                                            ...
                                            <td class="px-1 pt-5 text-sm text-red-500">
                                        ...
                                        <tr class="text-gray-700">
                                            <td class="w-1/2 px-1 py-2">
                                                <div class="flex items-center text-sm">
                                                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                        @if ($item->user_buyer->detail_user->photo != null)
                                                            <img class="inline w-full h-full mr-3 rounded-full"
                                                                src="{{ url(Storage::url($item->user_buyer->detail_user->photo)) }}"
                                                                alt="photo profile">
                                                        @else
                                                            <svg class="inline w-full h-full mr-3 rounded-full text-gray-300"
                                                                fill="currentColor" viewBox="0 0 24 24">
                                                                <path
                                                                    d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                                            </svg>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-400">
                                                            {{ date('d M Y', strtotime($item->updated_at)) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="w-1/2 px-1 py-5 text-xs text-right text-red-500">
                                                ...
                                                @for ($i = 0; $i < 5; $i++)
                                                    @if ($i < $item->rating)
                                                        <svg width="20" height="19" viewBox="0 0 26 24"
                                                            fill="none" class="inline align-sub"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
