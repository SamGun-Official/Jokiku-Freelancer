                        ...
                        <form action="{{ route('member.approve.request', $order->id) }}" method="POST"
                            ...
                            <div class="flex p-8 border border-gray-300 rounded-lg bg-serv-upload-bg flex-grow">
                                <div class="w-2/3 flex-column">
                                    <label for="note" class="block mb-3 font-medium text-gray-700 text-md">Download
                                        File</label>
                                    <div
                                        ...
                                        <div class="m-auto text-center">
                                            ...
                                            @else
                                                ...
                                                <p class="text-sm text-gray-400">
                                                    When your file is ready to download, a button will appear here
                                                </p>
                                            @endif
                                            @if (isset($order->file))
                                    ...
                                    <div class="h-1/2 flex-column" id="note-area">
                                        <div class="grid grid-cols-6 gap-6 flex-grow">
                                            <div class="col-span-6 flex-column">
                                                <label for="note"
                                                    class="block mb-3 font-medium text-gray-700 text-md">Note From
                                                    Freelancer</label>
                                                <textarea placeholder="When your freelancer leaves a note, it will appear here..." type="text" name="note"
                                                    id="note" autocomplete="note"
                                                    class="block w-full py-3 flex-grow border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500 sm:text-sm mb-8 no-selection"
                                                    style="resize: none; cursor: initial;" rows="4" disabled readonly unselectable="on">{{ $order->note ?? '' }}</textarea>
                                                @if ($errors->has('note'))
                            ...
                            <div class="pt-4 text-right">
                                @if (isset($order->file) == false || $order->status_bayar == 1)
